 ...
 * Jindo Component
 * 
 * @version 1.0.3 NHN_Library:Jindo_Component-1.0.3;JavaScript Components for
 *          Jindo;
		...
		.$Class(
				{
					...
					upload : function() {
						this._appendIframe();
						var elForm = this.getFormElement(), welForm = jindo
								.$Element(elForm), sIframeName = this._welIframe
								.attr("name"), sFunctionName = sIframeName
								+ '_func', sAction = this.option("sUrl");
						welForm.attr({
							target : sIframeName,
							action : sAction
						});
